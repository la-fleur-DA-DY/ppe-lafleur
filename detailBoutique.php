			...
			if ( isset($_GET['idType']) )
			{
				...
				if ($idType == 'plantes.php')
				{
					try 
					{
						...
						echo '<table>';
						echo '<tr class="bord"><th>PHOTO</th><th>DESCRIPTION</th><th>PRIX</th><th>Ajouter au panier</th></tr>';
						...
						while ( $donnees = $reponseReq->fetch() )
						{
							...
							echo '<td><a href="panier.php?idpanier='.$donnees['produit_id'].'"> <img src="img/panier.png" height="50" /></a></td>';
							echo '</tr>';
						}
						echo '</table>';
					}
